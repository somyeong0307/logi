...
<div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
        <div class="p-4 pt-5">
            <a href="/main/view" class="img logo rounded-circle mb-5" style="background-image: url('${pageContext.request.contextPath}${sessionScope.image}');"></a>
            ...
            <div class="footer">
                <p>경상남도 사천시 반룡1로 52</p>
                <p>Tel : 010 - 3033 - 4625
                <br/>Mail: somyeong_lee@daum.net</p>
            </div>
        </div>
    </nav>
